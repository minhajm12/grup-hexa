...
<body>
    ...
    <!-- media section -->
    <section id="approach-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec">
                            <div>
                                ...
                                <h2 class="main-title">Approach: <span class="main-grade">Enable the world to be in order by state-of-the-art approach</span></h2>
                            </div>
                            <div>
                                <p class="main-para text-start">Constantly updating to incorporate the latest, technically and technologically advanced methods into the moral and functional compass of a business and/or administrative system can ensure the most desirable outcomes. The key is to be open to changes and camouflage oneself to the need of the hour. We intend to convey a sustainable ordered system to the world by expanding on an innovative and proven approach. In due course, we shall explore, perform and edify the world to follow viable sequential methods towards progress.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/approach-img.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

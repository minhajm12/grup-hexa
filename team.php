...
<body>
    ...
    <!-- media section -->
    <section id="team-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec">
                            <div>
                                ...
                                <h2 class="main-title">Team: <span class="main-grade">A Harmonious <br>Human Capital</span></h2>
                            </div>
                            <div>
                                <p class="main-para text-start">We intend to birth a team over the foundations of integrity , responsibility & teamwork. A strong team shall be one that doesn’t shy away from experimenting and improvising. We aspire to bring together a group of youngsters who are in sync with the current trends of business infrastructure. At the same time, we endorse our motto of sustainable development that ensures the benefit of the environment and man. Our team shall be responsible to facilitate the well being of the ecosystem and its inhabitants without compromising on quality, ethics and morals..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/team-1.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

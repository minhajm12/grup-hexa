...
<body>
    ...
    <section id="integrity-banner" class="mainbanner-sec">
    ...
    <!-- media section -->
    <section id="itegrity-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec">
                            <div>
                                ...
                                <h2 class="main-title">Integrity <span class="main-grade">Greener, Healthier, Better!</span></h2>
                            </div>
                            <div>
                    ...
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/integrity.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

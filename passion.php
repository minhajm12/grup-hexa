...
<body>
    ...
    <section id="company-banner" class="mainbanner-sec">
    ...
    <!-- media section -->
    <section id="passion-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec">
                            <div>
                                <p class="top-title text-start">Who We Are</p>
                                <h2 class="main-title">Passion: <span class="main-grade">To Put Things<br> in Order</span></h2>
                            </div>
                            <div>
                                <p class="main-para text-start">We hope to bring harmony to the world by putting things in order. We envision a world where every aspect of life has an ordered system; from an individual to a group or from an entrepreneur to an enterprise. We believe in bringing out the best in people as we develop an inter-dependent work environment that is nothing short of leisure. By doing so, we shall bring sustainability to the system in the swiftest and most enduring ways. In the process, we intend to become the world’s most order-centric company that pushes people to give their best and reap the best benefits, while rejoicing one another’s growth.</p>
                                <p class="main-para text-start">Gruphexa functions on the foundation of aspiring to bring technological innovation and sustainable development together. We staunchly practice our motto in building an environment that highly nurturing and culturally, creatively and inspiringly active. The best of businesses flourish within comfortable, progressive and liberal spaces. As a team of innovators, gruphexa aspires to amalgamate all the right ingredients in transitioning businesses on the sustainable developmental model.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/passion-1.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

...
<body>
    ...
    <section id="sustainability-banner" class="mainbanner-sec">
    ...
    <!-- media section -->
    <section id="sustainability-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="1200">
                            <img src="assets/img/services/inner/sustainability.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

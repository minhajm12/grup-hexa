...
<head>
    ...
    <title>Environmental Ambition</title>
                    ...
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec">
                            <div>
                                ...
                                <h2 class="main-title">Our Commitment Recasting the Group’s <span class="main-grade">Environmental Ambition</span></h2>
                            </div>
                            <div>
                                <p class="main-para text-start">Offering customers solutions with environmental value while reducing the impact of the Group’s businesses on the climate, resources and natural environments shall be the prime motive that drives gruphexa.</p>
                                <p class="main-para text-start">The company is aware of its responsibility as a major concessions and construction group, and of the need to respond to climate change. hexa is committed to developing solutions by 2030 that will contribute to improving the living environment and mobility while managing and reducing the direct impact of its businesses. This goal encompasses and aspires to integrate three areas: climate change, the circular economy and the natural environment.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/quality-img.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>

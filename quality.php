...
<body>
    ...
    <!-- media section -->
    <section id="quality-section" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left order-2 order-lg-1">
                        <div class="content-parasec" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="1100">
                            <div>
                                ...
                                <h2 class="main-title">Quality: <span class="main-grade">Convergence of Quality and Artistry</span></h2>
                            </div>
                            <div>
                                <p class="main-para text-start">A satisfied customer is every business’ asset. gruphexa will extensively focus on customer satisfaction by providing the best possible quality of services that comprise e.p.c., b.e., Marine & Composite Engineering, Steel Processing, IT Services, Telecom Services, and Media Production. We have a highly advanced team to be proud of that will ensure that our promises are kept. Our Quality Management System (QMS) implements CSR strategies in all management level of organization to establish a sustainable development policy. The QMS will maintain, monitor and evaluate continuous effect and execution of CSR principles.</p>
                                <p class="main-para text-start">Our association will ensure that expected quality is maintained and inspected between timely intervals. To integrate the perfect business strategy, we implement the TQM integrated management philosophy that emphasizes on Continuous improvement, Meeting customers’ requirements, Reducing network, Long-range thinking, Increased employee involvement and teamwork, Process redesign, Competitive benchmarking, Team-based problem-solving, Constant measurement of results, and Closer relationships with suppliers.</p>
                            </div>
                        </div>
                    </div>

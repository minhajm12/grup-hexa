...
<header id="header" class="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php" data-aos="fade-left" data-aos-duration="800" data-aos-delay="1000">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon">
                        <!-- <svg class="menu-bar" width="110" height="81" viewBox="0 0 110 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path class="path-1" d="M26.4951 5.23242L104.638 5.23243" stroke="white" stroke-width="10" stroke-linecap="round"/>
                                    <path class="path-2" d="M5.12109 40.2324L104.638 40.2324" stroke="white" stroke-width="10" stroke-linecap="round"/>
                                    <path class="path-3" d="M47.0781 75.2324L104.637 75.2324" stroke="white" stroke-width="10" stroke-linecap="round"/>
                                    </svg>                                     -->
                    </span>
                </button>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item" data-aos="fade-left" data-aos-duration="800" data-aos-delay="1000">
                            <a class="nav-link offcnvs-nav industry" aria-current="page" href="#" data-target="industrysection">Industries</a>
                        </li>
                        <li class="nav-item" data-aos="fade-left" data-aos-duration="800" data-aos-delay="1100">
                            <a class="nav-link offcnvs-nav company" href="#" data-target="companysection">Company</a>
                        </li>
                        <li class="nav-item" data-aos="fade-left" data-aos-duration="800" data-aos-delay="1200">
                            <a class="nav-link offcnvs-nav commitment" href="#" data-target="commitmentsection">Commitment</a>
                        </li>
                        <li class="nav-item" data-aos="fade-left" data-aos-duration="800" data-aos-delay="1300">
    ...
    <div class="nav-canvas-items">
        <div class="container">
            <div class="industrysection nav-items-tabs dnone">
                <div class="industryitems">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link nav-drop-items active" id="pills-outlook-tab" data-bs-toggle="pill" data-bs-target="#pills-outlook" type="button" role="tab" aria-controls="pills-outlook" aria-selected="true">Outlook</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link nav-drop-items" id="pills-verticals-tab" data-bs-toggle="pill" data-bs-target="#pills-verticals" type="button" role="tab" aria-controls="pills-verticals" aria-selected="false">Verticals</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link nav-drop-items" id="pills-social-tab" data-bs-toggle="pill" data-bs-target="#pills-social" type="button" role="tab" aria-controls="pills-social" aria-selected="false">Social
                                Responsibility</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active nav-item-main" id="pills-outlook" role="tabpanel" aria-labelledby="pills-outlook-tab">
                        ...
                        <div class="tab-pane fade" id="pills-verticals" role="tabpanel" aria-labelledby="pills-verticals-tab">
                            <div class="nav-item-main">
                                ...
                                <a href="business-intelligence.php" class="inner-nav-items">
                                    <img src="assets/img/icons/business-intelligence.png" alt="" class="img-fluid">
                                ...
                                <a href="#" class="inner-nav-items">
                                    <img src="assets/img/icons/retail.png" alt="" class="img-fluid">
                                    <p class="inner-nav-title">Retail Utilities</p>
                                </a>
                            </div>
            ...
            <div class="companysection nav-items-tabs dnone">
            ...
            <div class="commitmentsection nav-items-tabs dnone">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li>
                        <a class="dropdown-item innerdrop outlook-drop" href="#" data-target="innerdropdown-outlook">Outlook <span>></span></a>
                    </li>
                    <li>
                        <a class="dropdown-item innerdrop vertical-drop" href="#" data-target="innerdropdown-verticals">Verticals <span>></span></a>
                    </li>
                    <li>
                        <a class="dropdown-item innerdrop social-drop" href="#" data-target="innerdropdown-social">Social Responsibility <span>></span></a>
                    </li>
                </ul>

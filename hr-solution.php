...
<body>
    <!-- hr banner Section -->
    <section id="hr-banner" class="mainbanner-sec">
    ...
    <!-- hr solution section -->
    <section id="hrsection" class="innerpg-section">
        <div class="container">
            <div class="top-sec">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 right order-1 order-lg-2">
                        <div class="img-div">
                            <img src="assets/img/services/inner/hr-solution-1.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
            <div class="bottom-sec">
                <div class="row">
                    <div class="col-12 col-lg-6 left">
                        <div class="img-div">
                            <img src="assets/img/services/inner/hr-solution-2.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
